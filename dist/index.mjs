...
function AssetChainKit({
  ...
  const [disbleEvm, setDisableEvm] = useState2(false);
  ...
  return /* @__PURE__ */ React.createElement(WagmiProvider, { config: wagmiConfig }, /* @__PURE__ */ React.createElement(QueryClientProvider, { client: queryClientOptions }, /* @__PURE__ */ React.createElement(
...
export {
  App_default as AssetChainKit,
  configs_default as config,
  sayHello,
  utils_default as utils,
  hooks_default as wallet
};
