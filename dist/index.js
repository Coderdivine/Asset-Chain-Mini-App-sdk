...
__export(src_exports, {
  AssetChainKit: () => App_default,
  config: () => configs_default,
  sayHello: () => sayHello,
  utils: () => utils_default,
  wallet: () => hooks_default
});
...
function AssetChainKit({
  ...
  const [disbleEvm, setDisableEvm] = (0, import_react3.useState)(false);
  ...
  return /* @__PURE__ */ import_react3.default.createElement(import_wagmi.WagmiProvider, { config: wagmiConfig }, /* @__PURE__ */ import_react3.default.createElement(import_react_query.QueryClientProvider, { client: queryClientOptions }, /* @__PURE__ */ import_react3.default.createElement(
    import_ui_react2.TonConnectUIProvider,
    {
      manifestUrl
    },
